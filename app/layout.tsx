...
export default function RootLayout({children}: Readonly<{children:React.ReactNode}>) {
 return <html lang="en"><body className={`${sans.variable} ${serif.variable}`}><a className="skip-link" href="#main">Skip to content</a><div className="topline"><div className="wrap"><span><MapPin size={13}/> A little more care. Right here in Arvada.</span><a href="tel:+13036579006"><Phone size={13}/> (303) 657-9006</a></div></div><Header/>{children}<footer><div className="wrap footer-main"><Link href="/" className="brand"><span className="brand-symbol">c<span>f</span></span><span>Caring Family<small>D E N T I S T R Y</small></span></Link><p>Thoughtful dentistry.<br/>Real relationships. Right here in Arvada.</p><div className="footer-links"><Link href="/about">Meet Dr. Moser</Link><Link href="/services">Our care</Link><Link href="/new-patients">New patients</Link><Link href="/visit">Visit us <ArrowUpRight size={14}/></Link></div></div><div className="wrap footer-bottom"><span>© {new Date().getFullYear()} Caring Family Dentistry</span><a href="https://303magazine.com/2022/02/truth-restoration-and-education-commission/" target="_blank" rel="noreferrer">Landscape: Kody Goodson / Unsplash</a><span>Private design preview · Details subject to confirmation.</span></div></footer></body></html>
}
